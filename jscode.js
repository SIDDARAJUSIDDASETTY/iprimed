...
var question = '<h1>Hi,what is your name?</h1>';				  // first question
...
function bot() { 
    ...
    output.innerHTML = '<h1>Any intresting thing in '+input + '</h1>';
    document.getElementById("input").value = "";   
    question = '<h1>Thank you for your time with me.</h1>';					      	
    setTimeout(timedQuestion, 2000);
    }
}
